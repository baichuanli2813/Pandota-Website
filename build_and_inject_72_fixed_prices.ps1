...
Write-Host "Building HTML for "$laptops.Count" laptops with 100% exact prices..."
...
# Construct template
$headerTemplate = Get-Content -Path "inventory_header.template" -Raw -ErrorAction SilentlyContinue
...
Write-Host "Successfully wrote inventory.html with all 72 prices intact!"
