...
Write-Host "Updating Lenovo Legion Go 2 to New and maintaining exact item conditions..."
...
foreach ($item in $items) {
    ...
    if ($itemId -eq "267755930402") {
        ...
        # All NEW items (Lenovo Legion Go 2, Sony cameras, lenses, Legion Pro 7i, Legion 9, Surface Pro 12) are NEW!
        $exactCond = "New"
        $condIcon = "fa-sparkles"
    } else {
        $exactCond = "Used"
...
Write-Host "Successfully updated Lenovo Legion Go 2 to NEW!"
