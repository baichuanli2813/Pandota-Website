...
Write-Host "Importing exact official eBay item conditions for all "$items.Count" listings..."
...
foreach ($item in $items) {
    ...
    # Official eBay UK Item Condition Taxonomy:
    # 1. New
    # 2. Opened - never used
    # 3. Used
...
Write-Host "Successfully built inventory.html with EXACT eBay condition names!"
