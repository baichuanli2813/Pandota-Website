$cardsBlock = Get-Content -Path "all_72_cards_block.html" -Raw
...
$html | Out-File -FilePath "inventory.html" -Encoding utf8
Write-Host "Updated inventory.html with all 72 laptop cards pre-rendered!"
